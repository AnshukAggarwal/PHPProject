<html>
    ...
    <?php 
        ...
        $results = $stats->searchpositionbyid($dbcon, $postid);
        if(isset($_POST['update']))
        {
            $position = $_POST['position'];
            $wages = $_POST['wages'];
            $stats->updateposition($dbcon, $position, $wages,$postid);
        }
    ?>
        <main id="main">
            ...
            ?>
                ...
                <div class="col-md-4">
                    <input type="text" name="position" class="form-control" value="<?= $result[2] ?>" />
                </div>
                <div class="col-md-2">
                    Wages :
                </div>
                <div class="col-md-4">
                    <input type="text" name="wages" class="form-control" value="<?= $result[3] ?>" />
                </div>
